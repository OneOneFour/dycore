...
'$Id: vert_coordinate.f90,v 10.0 2003/10/27 23:31:04 arl Exp $'
...
real, dimension(size(a)) :: a_sigma, b_sigma, a_press, b_press, f
...
if(size(a).ne.size(b)) then
  write(chtmp( 9:12),'(i4)') size(a)
  write(chtmp(23:26),'(i4)') size(b)
