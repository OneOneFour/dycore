...
character(len=128), parameter :: version = '$Id: grid_fourier.f90,v 10.0 2003/10/27 23:31:04 arl Exp $'
...
if(size(deg_lon_out).ne.num_lon) then
  write(chtmp1,'(i8)') size(deg_lon_out)
  write(chtmp2,'(i8)') num_lon
