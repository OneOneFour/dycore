...
character(len=128), parameter :: version = '$Id: implicit.f90,v 10.0 2003/10/27 23:31:04 arl Exp $'
...
real, dimension(size(ref_temperature_implicit_in)  ) :: p_full_work_1, p_full_work_2, ln_p_full_work_1, ln_p_full_work_2
real, dimension(size(ref_temperature_implicit_in)+1) :: p_half_work_1, p_half_work_2, ln_p_half_work_1, ln_p_half_work_2
...
num_levels = size(ref_temperature_implicit_in)
...
allocate( pk(size(pk_in)),  bk(size(bk_in)))
...
real, dimension (size(del_t)) :: geopot

complex, dimension(0:0, 0:0, size(del_t)  ) :: del_t_3d, geopot_3d
complex, dimension(0:0, 0:0, size(del_t)+1) :: del_ln_p_half_3d
complex, dimension(0:0, 0:0, size(del_t)  ) :: del_ln_p_full_3d
...
complex, dimension(0:0,0:0,size(div)) :: div_3d, dt_t_3d
