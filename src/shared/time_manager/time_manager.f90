...
character(len=128) :: version='$Id: time_manager.f90,v 10.0 2003/10/27 23:31:05 arl Exp $'
character(len=128) :: tagname='$Id: time_manager.f90,v 10.0 2003/10/27 23:31:05 arl Exp $'
