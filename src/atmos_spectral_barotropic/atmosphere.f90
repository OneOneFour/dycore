...
! version information 
!========================================================================
character(len=128) :: version = '$Id: atmosphere.f90,v 10.0 2003/10/27 23:31:04 arl Exp $'
...
call barotropic_dynamics_init (Dyn, Time, Time_init)  
...
call barotropic_diagnostics_init(Time, num_lon, num_lat)
...
enstrophy = &
area_weighted_global_mean(Dyn%grid%vor(:,:,current)*Dyn%grid%vor(:,:,previous))
