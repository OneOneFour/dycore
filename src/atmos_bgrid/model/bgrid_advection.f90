...
!  performance timing info
 ...
 character(len=128) :: version='$Id: bgrid_advection.f90,v 10.0 2003/10/27 23:31:04 arl Exp $'
...
!-----------------------------------------------------------------------
   ...
   real, dimension(lbound(var,2):ubound(var,2)) :: areax, areay
