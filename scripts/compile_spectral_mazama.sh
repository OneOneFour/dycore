...
workdir=$ATM_DYCORES_RUN_DIR/workdir_${COMP_MPI}  # where model is run and model output is produced
...
pushenv("MPPNCCOMBINE", pathJoin(BIN_DIR, "mppnccombine.mazama"))
--
